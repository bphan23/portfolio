      ...
      <div id="project-container" data-aos="fade-up">
        <div id="proj-item-1" class="project-item" data-aos="fade-right">
          ...
          <div class="div-two">
            ...
            <div class="project-item-description">
              <p>
                Collaborated in a team of 4 to refactor, automate, scale, and
                monetize an existing codebase
              </p>
              <br />
        ...
        <div id="proj-item-2" class="project-item" data-aos="fade-left">
          ...
          <div class="div-two">
            ...
            <div class="project-item-description">
              <p>
                Developed an online sneaker store where users could search,
                filter and purchase the most sought after sneakers in today’s
                market
              </p>
              <br />
              <p class="tech-used">
                React, JavaScript, HTML, CSS, and Supabase
              </p>
            </div>
            <div class="project-item-navigation">
              <button>
        ...
        <div id="proj-item-4" class="project-item" data-aos="fade-right">
          ...
          <div class="div-two">
            ...
            <div class="project-item-description">
              <p>
                Implemented a full-stack application that allows users to select
                a starting and ending building from the University of Washington
                campus, which generates the shortest path between the two
                building
              </p>
              <br />
              <p class="tech-used">
                Java, TypeScript, React, HTML, CSS, Spark Java
              </p>
            </div>
            <div class="project-item-navigation"></div>
          </div>
